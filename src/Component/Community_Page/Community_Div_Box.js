...
import { Community_Box_Items } from './Community_Box_Items'
import { Link } from 'react-router-dom'


const Community_Div_Box = () => {
    return (
        <>
            <div className=' lg:grid lg:justify-items-center items-center' >


                <div className='grid grid-cols-2 items-center justify-center m-4 gap-2 lg:w-[1000px] lg:h-fit lg:justify-items-center  lg:grid lg:grid-cols-4 lg:mb-2  '>
                    {
                        Community_Box_Items.map((item) => {
...
export default Community_Div_Box